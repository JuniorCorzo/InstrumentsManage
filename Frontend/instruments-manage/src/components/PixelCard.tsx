...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`w-full h-full relative overflow-hidden grid place-items-center aspect-[4/5] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
    ...
    >
      <canvas className="w-10/12 h-10 block" ref={canvasRef} />
      {children}
    </div>
  );
}
